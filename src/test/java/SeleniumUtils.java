...
public class SeleniumUtils {
    ...
    public SeleniumUtils(){
        ...
        String path = "C:\\Users\\dmg01\\javapractice\\src\\podTwo.InClassProject\\src\\main\\resources\\chromedriver.exe";
    ...
    public boolean enterTextIntoTextBox( WebElement element, String strText){
        try {
            if (waitUntilElementDisplayed(element)) {
                //driver.findElement(By.xpath(element)).clear();
                try {
